...
begin
    case morse is    
        when "00000010" => return x"41"; -- A (.-) --omvänd ordning på våra binära värden för bit count börja från vänster ej höger
        when "00000001" => return x"42"; -- B (-...)
        when "00000101" => return x"43"; -- C (-.-.)
        when "00000000" => return x"53"; -- S (...)
        when "00000111" => return x"4F"; -- O(---)
